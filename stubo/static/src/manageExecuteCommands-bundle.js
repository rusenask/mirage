	...
	var ExecuteCmdsFile = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_reactBootstrap.ButtonInput, { type: 'reset', bsStyle: 'primary', onClick: this.resetValidation }),
	            _react2['default'].createElement(_reactBootstrap.ButtonInput, { type: 'submit', value: 'Execute from file', bsStyle: this.state.style, bsSize: 'small', disabled: this.state.disabled })
	        );
	    }
	});
