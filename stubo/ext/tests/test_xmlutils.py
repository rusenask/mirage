...
class TestXMLMangler(unittest.TestCase):
    ...
    def test_mangle_attrs_copied_on_matches(self):
        ...
        result = mangler.mangle(xml, d="'01'", y="'2015'")
        self.assertEqual(result, '<a name="foo"><dateTime><year>2015</year><day daylight="false">01</day></dateTime></a>')    
    ...
    def test_mangle_namespaces(self):
        ...
        result = mangler.mangle(xml, d="'01'", y="'2015'")
        self.assertEqual(result, '<a xmlns:user="http://www.my.com/userschema" xmlns:info="http://www.my.com/infoschema"><user:dateTime><info:year>2015</info:year><info:day>01</info:day></user:dateTime></a>')    
    ...
    def test_mangle_namespaces_ignore_non_matching_path(self):
        ...
        result = mangler.mangle(xml, d="'01'", y="'2015'")
        self.assertEqual(result, '<a xmlns:user="http://www.my.com/userschema" xmlns:info="http://www.my.com/infoschema"><user:dateTime><info:year>2014</info:year><info:day>01</info:day></user:dateTime></a>')    
    ...
    def test_mangle_element_and_attr_namespaces(self):
        ...
        result = mangler.mangle(xml, d="'01'", y="'2015'", daylight="'false'")
        self.assertEqual(result, '<a xmlns:user="http://www.my.com/userschema" xmlns:info="http://www.my.com/infoschema"><user:dateTime><info:year>2015</info:year><info:day daylight-savings="false">01</info:day></user:dateTime></a>')
